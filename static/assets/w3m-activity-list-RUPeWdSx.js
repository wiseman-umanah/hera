import{Ct as e,Ft as t,S as n,St as r,W as i,Z as a,at as o,d as s,g as c,gt as l,h as u,lt as d,nt as f,u as p,v as m}from"./index-Hgd7YVhZ.js";import{o as h,s as g}from"./wui-text--yDNlxBX.js";import{t as _}from"./if-defined-D-H_in_I.js";import"./wui-image-QbGCkEsM.js";import"./wui-icon-box-XNpqYXaA.js";import"./wui-shimmer-DKyMUvwq.js";import"./wui-link-BTK_1eza.js";import"./wui-icon-box-Bbop6NSD.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=c`
  :host > wui-flex {
    display: flex;
